...
class FactionCommands {
    ...
    public function onCommand(CommandSender $sender, Command $command, string $label, array $args): bool {
        if (strtolower($command->getName()) !== "l" || empty($args)) {
            $sender->sendMessage($this->plugin->formatMessage("Please use /l help for a list of commands"));
            return true;
        }
        if (strtolower($args[0]) == "help") {
            $sender->sendMessage(TextFormat::RED . "\n/l about\n/l accept\n/f overclaim [Takeover the plot of the requested league]\n/l claim\n/l create <name>\n/l del\n/l demote <player>\n/l deny");
            $sender->sendMessage(TextFormat::RED . "\n/l home\n/l help <page>\n/l info\n/f info <league>\n/l invite <player>\n/l kick <player>\n/l leader <player>\n/l leave");
            $sender->sendMessage(TextFormat::RED . "\n/l sethome\n/l unclaim\n/l unsethome\n/l ourmembers - {Members + Statuses}\n/l ourofficers - {Officers + Statuses}\n/l ourleader - {Leader + Status}\n/l allies - {The allies of your league");
            $sender->sendMessage(TextFormat::RED . "\n/l desc\n/l promote <player>\n/l allywith <league>\n/l breakalliancewith <league>\n\n/l allyok [Accept a request for alliance]\n/l allyno [Deny a request for alliance]\n/l allies <league> - {The allies of your chosen league}");
            $sender->sendMessage(TextFormat::RED . "\n/l membersof <league>\n/l officersof <league>\n/l leaderof <league>\n/l say <send message to everyone in your league>\n/l pf <player>\n/l topfactions");
            $sender->sendMessage(TextFormat::RED . "\n/l forceunclaim <league> [Unclaim a faction plot by force - OP]\n\n/l forcedelete <league> [Delete a faction by force - OP]");
            return true;
        }
        ...
        $playerName = $sender->getPlayer()->getName();
            ...
            if ($args[0] == "war") {
                if (!isset($args[1])) {
                    $sender->sendMessage($this->plugin->formatMessage("Usage: /l war <league name:tp>"));
                    return true;
                }
                ...
                if (!$this->plugin->factionExists($args[1])) {
                    $sender->sendMessage($this->plugin->formatMessage("league does not exist"));
                    return true;
                }
                if (!$this->plugin->isInFaction($sender->getName())) {
                    $sender->sendMessage($this->plugin->formatMessage("You must be in a league to do this"));
                    return true;
                }
                if (!$this->plugin->isLeader($playerName)) {
                    $sender->sendMessage($this->plugin->formatMessage("Only your league leader may start wars"));
                    return true;
                }
                if (!$this->plugin->areEnemies($this->plugin->getPlayerFaction($playerName), $args[1])) {
                    $sender->sendMessage($this->plugin->formatMessage("Your league is not an enemy of $args[1]"));
                    return true;
                } else {
                    $factionName = $args[1];
                    ...
                    $sender->sendMessage("League leader is not online.");
                    return true;
                }
            }
            ...
            if ($args[0] == "create") {
                if (!isset($args[1])) {
                    $sender->sendMessage($this->plugin->formatMessage("Usage: /l create <league name>"));
                    return true;
                }
                if (!($this->alphanum($args[1]))) {
                    $sender->sendMessage($this->plugin->formatMessage("You may only use letters and numbers"));
                ...
                if ($this->plugin->factionExists($args[1])) {
                    $sender->sendMessage($this->plugin->formatMessage("The League already exists"));
                    return true;
                }
                ...
                if ($this->plugin->isInFaction($sender->getName())) {
                    $sender->sendMessage($this->plugin->formatMessage("You must leave the league first"));
                    return true;
                } else {
                    $factionName = $args[1];
                    $rank = "Leader";
            ...
            if ($args[0] == "invite") {
                if (!isset($args[1])) {
                    $sender->sendMessage($this->plugin->formatMessage("Usage: /l invite <player>"));
                    return true;
                }
                if ($this->plugin->isFactionFull($this->plugin->getPlayerFaction($playerName))) {
                    $sender->sendMessage($this->plugin->formatMessage("League is full, please kick players to make room"));
                    return true;
                }
                ...
                if ($this->plugin->isInFaction($invited->getName()) == true) {
                    $sender->sendMessage($this->plugin->formatMessage("Player is currently in a league"));
                    return true;
                }
                if ($this->plugin->prefs->get("OnlyLeadersAndOfficersCanInvite")) {
                    if (!($this->plugin->isOfficer($playerName) || $this->plugin->isLeader($playerName))) {
                        $sender->sendMessage($this->plugin->formatMessage("Only your league leader/officers can invite"));
                        return true;
                    }
                }
                if ($invited->getName() == $playerName) {

                    $sender->sendMessage($this->plugin->formatMessage("You can't invite yourself to your own league"));
                    return true;
                }
                ...
                $invited->sendMessage($this->plugin->formatMessage("You have been invited to $factionName. Type '/l accept' or '/l deny' into chat to accept or deny!", true));
            }
            ...
            if ($args[0] == "leader") {
                if (!isset($args[1])) {
                    $sender->sendMessage($this->plugin->formatMessage("Usage: /l leader <player>"));
                    return true;
                }
                if (!$this->plugin->isInFaction($sender->getName())) {
                    $sender->sendMessage($this->plugin->formatMessage("You must be in a league to use this"));
                    return true;
                }
                if (!$this->plugin->isLeader($playerName)) {
                ...
                if ($this->plugin->getPlayerFaction($playerName) != $this->plugin->getPlayerFaction($args[1])) {
                    $sender->sendMessage($this->plugin->formatMessage("Add player to league first"));
                    return true;
                }
            ...
            if ($args[0] == "promote") {
                if (!isset($args[1])) {
                    $sender->sendMessage($this->plugin->formatMessage("Usage: /l promote <player>"));
                    return true;
                }
                if (!$this->plugin->isInFaction($sender->getName())) {
                    $sender->sendMessage($this->plugin->formatMessage("You must be in a league to use this"));
                ...
                if ($this->plugin->getPlayerFaction($playerName) != $this->plugin->getPlayerFaction($args[1])) {
                    $sender->sendMessage($this->plugin->formatMessage("Player is not in this league"));
                    return true;
                }
            ...
            if ($args[0] == "kick") {
                if (!isset($args[1])) {
                    $sender->sendMessage($this->plugin->formatMessage("Usage: /l kick <player>"));
                    return true;
                }
                if ($this->plugin->isInFaction($sender->getName()) == false) {
                    $sender->sendMessage($this->plugin->formatMessage("You must be in a league to use this"));
            ...
            if (strtolower($args[0]) == 'claim') {
                if (!$this->plugin->isInFaction($playerName)) {
                    $sender->sendMessage($this->plugin->formatMessage("You must be in a league."));
                    return true;
                }
                if (!$this->plugin->isLeader($playerName)) {
                    $sender->sendMessage($this->plugin->formatMessage("You must be leader to use this."));
                ...
                if (!in_array($sender->getPlayer()->getLevel()->getName(), $this->plugin->prefs->get("ClaimWorlds"))) {
                    $sender->sendMessage($this->plugin->formatMessage("You can only claim in League Worlds: " . implode(" ", $this->plugin->prefs->get("ClaimWorlds"))));
                    return true;
                }

                if ($this->plugin->inOwnPlot($sender)) {
                    $sender->sendMessage($this->plugin->formatMessage("Your league has already claimed this area."));
                    return true;
                }
                ...
                if ($this->plugin->getNumberOfPlayers($faction) < $this->plugin->prefs->get("PlayersNeededInFactionToClaimAPlot")) {
                    ...
                    $sender->sendMessage($this->plugin->formatMessage("You need $needed_players more players in your league to claim land"));
                    return true;
                }
                if ($this->plugin->getFactionPower($faction) < $this->plugin->prefs->get("PowerNeededToClaimAPlot")) {
                    ...
                    $sender->sendMessage($this->plugin->formatMessage("Your league doesn't have enough STR to claim a land."));
                    $sender->sendMessage($this->plugin->formatMessage("$needed_power STR is required but your league has only $faction_power STR."));
                    return true;
                }
            ...
            if (strtolower($args[0]) == "accept") {
                ...
                if (empty($array) == true) {
                    $sender->sendMessage($this->plugin->formatMessage("You have not been invited to any league"));
                    return true;
                }
                ...
                if (($currentTime - $invitedTime) <= 60) { //This should be configurable
                    ...
                    if ($inviter !== null) $inviter->sendMessage($this->plugin->formatMessage("$playerName joined the league", true));
                    $this->plugin->updateTag($sender->getName());
                } else {
            ...
            if (strtolower($args[0]) == "del") {
                if ($this->plugin->isInFaction($playerName) == true) {
                    if ($this->plugin->isLeader($playerName)) {
                        ...
                        $sender->sendMessage($this->plugin->formatMessage("League successfully disbanded and members are left alone", true));
                        $this->plugin->updateTag($sender->getName());
                    ...
                    $sender->sendMessage($this->plugin->formatMessage("You are not in a league!"));
                }
            }
            ...
            if (strtolower($args[0] == "leave")) {
                if ($this->plugin->isLeader($playerName) == false) {
                    ...
                    $sender->sendMessage($this->plugin->formatMessage("You must delete the league or give\nleadership to someone else first"));
                }
            }
            ...
            if (strtolower($args[0] == "enemywith")) {
                if (!isset($args[1])) {
                    $sender->sendMessage($this->plugin->formatMessage("Usage: /l enemywith <league>"));
                    return true;
                }
                if (!$this->plugin->isInFaction($playerName)) {
                    $sender->sendMessage($this->plugin->formatMessage("You must be in a league to do this"));
                ...
                if (!$this->plugin->factionExists($args[1])) {
                    $sender->sendMessage($this->plugin->formatMessage("The requested league doesn't exist"));
                    return true;
                }
                if ($this->plugin->getPlayerFaction($playerName) == $args[1]) {
                    $sender->sendMessage($this->plugin->formatMessage("A league can not be an enemy of itself"));
                    return true;
                }
                if ($this->plugin->areAllies($this->plugin->getPlayerFaction($playerName), $args[1])) {
                    $sender->sendMessage($this->plugin->formatMessage("Your league is an ally of $args[1]"));
                    return true;
                }
                if ($this->plugin->areEnemies($this->plugin->getPlayerFaction($playerName), $args[1])) {
                    $sender->sendMessage($this->plugin->formatMessage("Your league is already an enemy of $args[1]"));
                    return true;
                }
                $fac = $this->plugin->getPlayerFaction($playerName);
                ...
                if (!($leader instanceof Player)) {
                    $sender->sendMessage($this->plugin->formatMessage("The leader of the requested league is offline"));
                } else {
                    $leader->sendMessage($this->plugin->formatMessage("The leader of $fac has declared your league are enemies", true));
                }
            ...
            if (strtolower($args[0] == "notenemy")) {
                if (!isset($args[1])) {
                    $sender->sendMessage($this->plugin->formatMessage("Usage: /l notenemy <league>"));
                    return true;
                }
                if (!$this->plugin->isInFaction($playerName)) {
                    $sender->sendMessage($this->plugin->formatMessage("You must be in a league to do this"));
                ...
                if (!($leader instanceof Player)) {
                    ...
                    $leader->sendMessage($this->plugin->formatMessage("The leader of $fac has declared your league are no longer enemies", true));
                }
                $sender->sendMessage($this->plugin->formatMessage("You are no longer enemies with $args[1]!", true));
            }
            if (strtolower($args[0] == "allywith")) {
                if (!isset($args[1])) {
                    $sender->sendMessage($this->plugin->formatMessage("Usage: /l allywith <faction>"));
                    return true;
                }
                if (!$this->plugin->isInFaction($playerName)) {
                    $sender->sendMessage($this->plugin->formatMessage("You must be in a league to do this"));
                ...
                if ($this->plugin->getPlayerFaction($playerName) == $args[1]) {
                    $sender->sendMessage($this->plugin->formatMessage("Your league can not ally with itself"));
                    return true;
                }
                if ($this->plugin->areAllies($this->plugin->getPlayerFaction($playerName), $args[1])) {
                    $sender->sendMessage($this->plugin->formatMessage("Your league is already allied with $args[1]"));
                    return true;
                }
                $fac = $this->plugin->getPlayerFaction($playerName);
                $leaderName = $this->plugin->getLeader($args[1]);
                if (!isset($fac) || !isset($leaderName)) {
                    $sender->sendMessage($this->plugin->formatMessage("League not found"));
                    return true;
                }
                ...
                if ($this->plugin->getAlliesCount($args[1]) >= $this->plugin->getAlliesLimit()) {
                    $sender->sendMessage($this->plugin->formatMessage("The requested league has the maximum amount of allies", false));
                    return true;
                }
                if ($this->plugin->getAlliesCount($fac) >= $this->plugin->getAlliesLimit()) {
                    $sender->sendMessage($this->plugin->formatMessage("Your league has the maximum amount of allies", false));
                    return true;
                }
            ...
            if (strtolower($args[0] == "breakalliancewith") or strtolower($args[0] == "notally")) {
                ...
                $this->plugin->updateAllies($fac);
                $this->plugin->updateAllies($args[1]);
                $sender->sendMessage($this->plugin->formatMessage("Your league $fac is no longer allied with $args[1]", true));
                if ($leader instanceof Player) {
                    $leader->sendMessage($this->plugin->formatMessage("The leader of $fac broke the alliance with your league $args[1]", false));
                }
            }
            ...
            if (strtolower($args[0] == 'about')) {
                $sender->sendMessage(TextFormat::GREEN . "[ORIGINAL] LeagueV1 " . TextFormat::BOLD . "AsylumPE");
            ...
            if (strtolower($args[0]) == "chat" or strtolower($args[0]) == "c") {
                ...
                if (!$this->plugin->prefs->get("AllowChat")) {
                    $sender->sendMessage($this->plugin->formatMessage("All League chat is disabled", false));
                    return true;
                }
                ...
                if ($this->plugin->isInFaction($playerName)) {
                    if (isset($this->plugin->factionChatActive[$playerName])) {
                        unset($this->plugin->factionChatActive[$playerName]);
                        $sender->sendMessage($this->plugin->formatMessage("League chat disabled", false));
                        return true;
                    } else {
                        $this->plugin->factionChatActive[$playerName] = 1;
                        $sender->sendMessage($this->plugin->formatMessage("§aLeague chat enabled", false));
                        return true;
                    }
                } else {
                    $sender->sendMessage($this->plugin->formatMessage("You are not in a league"));
            ...
            if (strtolower($args[0]) == 'info') {
                if (isset($args[1])) {
                    if (!(ctype_alnum($args[1])) or !($this->plugin->factionExists($args[1]))) {
                        $sender->sendMessage($this->plugin->formatMessage("League does not exist"));
                        $sender->sendMessage($this->plugin->formatMessage("Make sure the name of the selected league is ABSOLUTELY EXACT."));
                        return true;
                    }
                    $faction = $args[1];
                    ...
                    $sender->sendMessage(TextFormat::GOLD . TextFormat::ITALIC . ": League : " . TextFormat::GREEN . "$faction" . TextFormat::RESET);
                    $sender->sendMessage(TextFormat::GOLD . TextFormat::ITALIC . ": Founder : " . TextFormat::YELLOW . "$leader" . TextFormat::RESET);
                    $sender->sendMessage(TextFormat::GOLD . TextFormat::ITALIC . ":Population : " . TextFormat::LIGHT_PURPLE . "$numPlayers" . TextFormat::RESET);
                    $sender->sendMessage(TextFormat::GOLD . TextFormat::ITALIC . ": Army Power : " . TextFormat::RED . "$power" . " STR" . TextFormat::RESET);
            ...
            if ($this->plugin->prefs->get("EnableMap") && (strtolower($args[0]) == "map" or strtolower($args[0]) == "m")) {
                ...
                if ($factionPlots == null) {
                    $sender->sendMessage(TextFormat::RED . "No nearby league found");
                    return true;
                }
                ...
                foreach ($factionPlots as $key => $faction) {
                    ...
                    if ($this->plugin->isInPlot($sender)) {
                        ...
                        if ($inWhichPlot == $plotFaction) {
                            $sender->sendMessage(TextFormat::GREEN . "You are in league " . $plotFaction . "'s plot");
                            $found = true;
                            continue;
                        }
                    }
